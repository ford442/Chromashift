...
export function buildControlProps(
  ...
  return {
    ...
    motionMode: tracers.motionMode,
    setMotionMode: actions.setMotionMode,
    motionGain: tracers.motionGain,
    setMotionGain: actions.setMotionGain,
    motionDecayBias: tracers.motionDecayBias,
    setMotionDecayBias: actions.setMotionDecayBias,
    motionThreshold: tracers.motionThreshold,
    setMotionThreshold: actions.setMotionThreshold,
