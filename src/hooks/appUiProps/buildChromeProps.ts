...
export function buildChromeProps(
  ...
  return {
    ...
    handleStartCamera: handlers.handleStartCamera,
    handleStartScreenShare: handlers.handleStartScreenShare,
    handleLoadVideoFile: handlers.handleLoadVideoFile,
    handleStopLiveSource: handlers.handleStopLiveSource,
